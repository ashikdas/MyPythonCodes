...
laptop_1 = Laptop('Asus g14', 130000, 1.6, 'Moonlight Silver', 16, 'Ryzan 4800H', 1000)
laptop_2 = Laptop('MacBook Pro 13', 130000, 1.7, 'Dark Gray', 8, 'Intel Core i7', 512)
laptop_3 = Laptop('Dell XPS 13', 140000, 1.4, 'White', 16, 'Intel Core i7', 100)
...
# Applying the discount upon the droduct
